...
import java.util.ArrayList;	import org.javaro.mybookstore.Book;
import org.javaro.mybookstore.Student;
public class BookStore {
	public String storeName;	public ArrayList<Book> books;
	public ArrayList<Student> students;
	public BookStore(String storeName) {
		this.storeName = storeName;	books = new ArrayList<Book>();
	...
	public String toString() {
		return this.getStoreName()+"의 보유책="+this.getBooks().size()+
				"권, 회원수="+this.getStudents().size()+"명";
	}
